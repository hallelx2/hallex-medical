        ...
        <div className="w-full max-w-md">
            ...
            <SignIn.Step name="start">
              <div className="space-y-6">
                <Clerk.Field name="identifier">
                  <Clerk.Label className="text-slate-700 font-bold text-xs uppercase tracking-widest mb-2 block text-left">
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-2 text-slate-400 font-bold tracking-widest">Authorized OAuth</span>
                  </div>
                </div>
          ...
          <div className="mt-8 text-center border-t border-slate-50 pt-8">
            <p className="text-sm text-slate-500 font-medium">
              New to St. Mary's?{" "}
              <Link href="/sign-up" className="text-primary font-bold hover:underline">Create Staff Profile</Link>
            </p>
          </div>
