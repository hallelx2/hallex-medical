    ...
    <div className="flex min-h-screen items-center justify-center bg-background-light dark:bg-background-dark">
      <div className="w-full max-w-md p-4">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Medical Staff Registration</h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400 font-medium">Join St. Mary's Voice Triage System</p>
        </div>
        <SignUp 
          appearance={{
            elements: {
