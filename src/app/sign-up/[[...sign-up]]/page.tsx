      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-md">
          <div className="mb-10 text-left">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Staff Registration</h1>
              ...
              <div className="space-y-6">
                ...
                <div className="relative py-4">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-white px-2 text-slate-400 font-bold tracking-widest">Rapid Onboarding</span>
                  </div>
                </div>
          ...
          <div className="mt-8 text-center border-t border-slate-50 pt-8">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link href="/sign-in" className="text-primary font-bold hover:underline">Staff Sign In</Link>
            </p>
          </div>
        </div>
      </div>
