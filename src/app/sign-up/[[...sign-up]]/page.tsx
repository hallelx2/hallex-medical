      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-md">
          <div className="mb-10 text-left">
            ...
            <p className="mt-3 text-slate-500 font-medium">Create your clinical profile at St. Mary's.</p>
          </div>
          ...
          <SignUp 
            appearance={{
              elements: {
                ...
                socialButtonsBlockButton: "rounded-xl border border-slate-200 text-sm font-semibold h-12",
                formFieldInput: "rounded-xl border border-slate-200 bg-slate-50 h-12 focus:ring-2 focus:ring-primary/20 transition-all",
                footer: "hidden", 
                headerTitle: "hidden",
          ...
          <div className="mt-6 text-center border-t border-slate-50 pt-8">
            <p className="text-sm text-slate-500 font-medium italic">
              Already have a profile?{" "}
              <a href="/sign-in" className="text-primary font-bold hover:underline not-italic">Staff Sign In</a>
            </p>
          </div>
        </div>
      </div>
